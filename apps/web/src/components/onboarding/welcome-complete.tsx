...
export function WelcomeComplete({ onContinue }: WelcomeCompleteProps) {
	...
	useEffect(() => {
		...
		// Try to play and log any errors for debugging
		audio
			.play()
			.then(() => {
		...
		>
			...
			<div className='relative z-10 text-center'>
				<motion.h2
					...
					style={{
						background: 'linear-gradient(to top, #FFFFFF 0%, #ECECEC 50%, #E0E0E0 100%)',
			...
			<div className='relative z-10 mt-12'>
				...
				>
					...
					>
						...
						>
							<ArrowRight01Icon className='size-5 shrink-0' />
						</motion.span>
					</motion.button>
				</motion.div>
			</div>
