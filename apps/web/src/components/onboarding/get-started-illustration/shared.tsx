...
const ACTIVITY_ICONS: Record<string, (cls: string) => ReactNode> = {
	files: (cls) => <File01Icon size={16} className={cls} strokeWidth={1.5} />,
	search: (cls) => <Search01Icon size={16} className={cls} strokeWidth={1.5} />,
	scm: (cls) => <GitBranchIcon size={16} className={cls} strokeWidth={1.5} />,
	debug: (cls) => <Bug01Icon size={16} className={cls} strokeWidth={1.5} />,
	extensions: (cls) => (
		<PuzzleIcon size={16} className={cls} strokeWidth={1.5} />
	),
};
