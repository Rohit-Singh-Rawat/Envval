...
import { Clock01Icon, Key01Icon } from "hugeicons-react";
            ...
            return (
              ...
              >
                <div className="flex flex-col gap-1.5 min-w-0 flex-1">
                  <div
                    className={`h-2.5 ${row.nameWidth} rounded bg-muted-foreground/35`}
                  />
                  <div
                    className={`h-2 ${row.urlWidth} rounded bg-muted-foreground/20`}
                  />
                </div>
