			...
			<div className='flex flex-col items-center gap-16'>
				<div className='flex flex-col items-center text-center max-w-3xl'>
					...
					<p className='text-muted-foreground text-lg md:text-xl mb-10 leading-relaxed font-normal text-shadow-2xs text-shadow-muted-foreground/10'>
						We help teams sync, share, and manage environment variables across projects, without
						exposing sensitive data in your codebase.
					</p>
				...
				<div className='w-full max-w-8xl'>
					<div className='relative rounded-3xl overflow-hidden border border-border/50 p-8 aspect-video flex items-center justify-center'>
						<svg
						...
						<div className='relative aspect-video flex items-center justify-center rounded-2xl w-[85%] overflow-hidden'>
							<img
