...
export function DangerZone({ onRemoveAll, disabled, deviceCount }: DangerZoneProps) {
				...
				<div className="rounded-lg bg-background border overflow-hidden">
					...
					<div className="px-4 py-3">
						<div className="space-y-1">
							<h4 className="text-sm font-normal text-foreground">Remove All Devices</h4>
							<p className="text-xs text-muted-foreground">
								Immediately remove access for all other devices. This will sign them out and require
								re-authentication.
							</p>
						</div>
					</div>
						...
						<div className="flex items-center justify-between gap-4">
							<div className="flex items-start gap-2 flex-1">
								...
								<p className="text-xs text-amber-600 dark:text-amber-500 font-medium">
									This action cannot be undone. Use only if you suspect unauthorized access.
								</p>
							</div>
							<Button
								variant="destructive"
