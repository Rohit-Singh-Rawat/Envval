...
import { CompassIcon, UserIcon } from "hugeicons-react";
...
import {
  type StepConfig,
  StepProgress,
} from "@/components/onboarding/step-progress";
...
import {
  redirectIfOnboardedGuard,
  redirectIfOnboardedMiddleware,
    ...
    >
      <div className="w-full max-w-md relative flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-md p-5">
          <StepProgress steps={STEPS} currentStep={step} className="pb-40" />
