...
import { SOCIAL_LINKS, CONTACT_EMAILS } from '@/config/socials';
...
function ContactPage() {
	return (
		<StaticPage title='Contact' subtitle='Get in touch.'>
			<p>
				For general questions, bug reports, or feedback, the best way to reach me is
			...
			<p>
				...
				to <a href={`mailto:${CONTACT_EMAILS.security}`}>{CONTACT_EMAILS.security}</a>. Do not open a public issue.
			</p>
		</StaticPage>
	)
}
