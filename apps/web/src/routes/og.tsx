...
function OgImagePreview({ innerRef }: { innerRef: React.RefObject<HTMLDivElement | null> }) {
	return (
		<div
			ref={innerRef}
			style={{
		...
		>
			...
			>
				...
				>
					...
					{/* Tagline area */}
					<div style={{ display: 'flex', flexDirection: 'column', gap: 24, marginBottom: 42 }}>
						<h1
							style={{
								fontSize: 56,
								fontWeight: 500,
						...
						>
							Sync, share, and manage environment variables across your team without exposing
							sensitive data.
						</p>
					</div>
				</div>
...
function OgPage() {
	...
	return (
		...
		>
			...
			{downloading && <p style={{ fontSize: 13, color: '#888' }}>Generating image...</p>}
		</div>
	);
}
