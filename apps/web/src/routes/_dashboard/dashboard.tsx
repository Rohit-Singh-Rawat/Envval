            ...
            <Tooltip>
              <TooltipTrigger>
                <div
                  ...
                  tabIndex={0}
                >
                  <Key01Icon className="size-4 text-primary/70" />
            ...
            <Tooltip>
              <TooltipTrigger>
                <div
                  ...
                  tabIndex={0}
                >
                  <Clock01Icon className="size-4 text-muted-foreground/70" />
...
function ProjectList({ repos }: { repos: Project[] }) {
  ...
  return (
    <>
      <ul className="flex flex-col gap-1" aria-label="Projects list">
        {repos.map((repo) => (
          <ProjectItem
            key={repo.id}
            project={repo}
