...
const ResponsiveAlertContext = React.createContext<{ isMobile: boolean }>({
  isMobile: false,
});
...
export function ResponsiveAlertContent({
  children,
  className,
}: ResponsiveAlertContentProps) {
...
export function ResponsiveAlertHeader({
  children,
  className,
}: ResponsiveAlertHeaderProps) {
  const { isMobile } = React.useContext(ResponsiveAlertContext);
...
export function ResponsiveAlertFooter({
  children,
  className,
}: ResponsiveAlertFooterProps) {
  const { isMobile } = React.useContext(ResponsiveAlertContext);
...
export function ResponsiveAlertTitle({
  children,
  className,
}: ResponsiveAlertTitleProps) {
  const { isMobile } = React.useContext(ResponsiveAlertContext);
...
export function ResponsiveAlertDescription({
  children,
  className,
}: ResponsiveAlertDescriptionProps) {
  const { isMobile } = React.useContext(ResponsiveAlertContext);
