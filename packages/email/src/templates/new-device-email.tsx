...
const NewDeviceEmailTemplate = (
  ...
  const infoRows: Array<{ label: string; value: string }> = [
    ...
    ...(location
      ? [
          {
            label: "Location",
            value: ipAddress ? `${location} (${ipAddress})` : location,
          },
        ]
      : []),
  ...
  return (
    <EmailLayout productName={productName} logoUrl={logoUrl}>
      ...
      >
        A new device just signed in to your <strong>{productName}</strong>{" "}
        account. If you don&apos;t recognize this device, please check your
        account for any unauthorized activity, and also make sure that the sign
        in type used is secure.
      </p>
