...
export const EmailLayout = ({
	...
	>
		...
		>
			<p style={{ margin: 0, color: '#999', fontSize: '12px', lineHeight: 1.5 }}>
...
export const PrimaryButton = ({ href, label }: PrimaryButtonProps): React.ReactElement => (
...
export const Muted = ({
	...
	<p style={{ margin: '0 0 8px 0', color: '#888', fontSize: `${size}px`, lineHeight: 1.5 }}>
		{children}
	</p>
);
